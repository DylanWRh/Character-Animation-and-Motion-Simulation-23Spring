...
class CharacterController():
    def __init__(self, controller, pd_controller) -> None:
        # 手柄/键盘控制器
    ...
    def update_state(self, 
        ...
        joint_translation, joint_orientation = self.motions[0].batch_forward_kinematics(root_pos=self.controller.viewer.root_pos)
